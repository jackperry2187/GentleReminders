...
public class DefaultSettings {
    ...
    public static final List<Message> defaultMessages = new ArrayList<>(Arrays.asList(
            ...
            generateUniqueMessage("The only way to do great work is to love what you do.", "- Steve Jobs", true, Formatting.DARK_BLUE, Formatting.GOLD),
            generateUniqueMessage("Believe you can and you're halfway there.", "- Theodore Roosevelt", true, Formatting.DARK_GREEN, Formatting.YELLOW),
            generateUniqueMessage("You must be the change you wish to see in the world.", "- Mahatma Gandhi", true, Formatting.GREEN, Formatting.GOLD),
            generateUniqueMessage("Don't watch the clock; do what it does. Keep going.", "- Sam Levenson", true, Formatting.DARK_BLUE, Formatting.GRAY),
            generateUniqueMessage("The best way out is always through.", "- Robert Frost", true, Formatting.DARK_GREEN, Formatting.DARK_RED),
            generateUniqueMessage("It is never too late to be what you might have been.", "- George Eliot", true, Formatting.GOLD, Formatting.DARK_GREEN),
            generateUniqueMessage("Everything you can imagine is real.", "- Pablo Picasso", true, Formatting.DARK_PURPLE, Formatting.LIGHT_PURPLE),
            generateUniqueMessage("No matter what people tell you - words and ideas can change the world.", "- Robin Williams", true, Formatting.RED, Formatting.DARK_RED),
            generateUniqueMessage("In the end - we only regret the chances we didn't take.", "- Lewis Carroll", true, Formatting.DARK_BLUE, Formatting.AQUA),
            generateUniqueMessage("Dream big and dare to fail.", "- Norman Vaughan", true, Formatting.DARK_GRAY, Formatting.LIGHT_PURPLE),
            generateUniqueMessage("If opportunity doesn't knock - build a door.", "- Milton Berle", true, Formatting.GOLD, Formatting.YELLOW),
            generateUniqueMessage("All our dreams can come true - if we have the courage to pursue them.", "- Walt Disney", true, Formatting.YELLOW, Formatting.BLUE),
            generateUniqueMessage("It always seems impossible until it’s done.", "- Nelson Mandela", true, Formatting.DARK_AQUA, Formatting.GRAY),
            generateUniqueMessage("A person who never made a mistake never tried anything new.", "- Albert Einstein", true, Formatting.LIGHT_PURPLE, Formatting.DARK_PURPLE),
            generateUniqueMessage("Never limit yourself because of others’ limited imagination.", "- Mae Jemison", true, Formatting.GOLD, Formatting.DARK_GREEN),
            generateUniqueMessage("Success is not in what you have - but who you are.", "- Bo Bennett", true, Formatting.GREEN, Formatting.DARK_GREEN)
    ));
}
