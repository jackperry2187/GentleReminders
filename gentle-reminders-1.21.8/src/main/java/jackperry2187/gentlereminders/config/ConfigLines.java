...
//                "###",
                ...
                "# \"dark\" and \"light\" will use the dark and light mode custom toasts, respectively",
                "# \"custom\" will use the custom background and border textures, and can optionally include the icon",
                "# \"chat\" will send the message as chat messages instead of toasts",
                "displayStyle=\"" + displayStyle + "\"",
                "# Uncomment the following lines to use the custom display style - they will not do anything if displayStyle is not set to \"custom\"!",
                "# The textures should be in the format of minecraft:block_id (support for other mods will be added in the future)",
                "# The include icon should be a boolean (true or false)",
                "# customBGTexture=\"" + customBGTexture + "\"",
                "# customBorderTexture=\"" + customBorderTexture + "\"",
                "# customIncludeIcon=\"" + customIncludeIcon + "\"",
                "###",
